...
#define newImproperTestNumbers 104
...
int main(int argc, const char * argv[]) {
    ...
    for ( i = 0; i < improperTestNumbers; i++) {
    ...
    for ( i = 0; i < newProperTestNumbers; i++) {
        printf("---------------------***   Test %d    ***------------------------\n\n", i + 1);
    ...
    for ( i = 100; i < newImproperTestNumbers; i++) {
